-- Script de déploiement complet pour le mode manuel par dossier
...
SELECT '--- VÉRIFICATION DE L''INSTALLATION ---' as info;

SELECT 
  'Colonnes master_id et master_name' as check_name,
  CASE 
...
SELECT 
  ...
  CASE 
    ...
    THEN '✅ COMPLÈTE - Prêt à utiliser !'
    ELSE '❌ INCOMPLÈTE - Vérifiez les erreurs ci-dessus'
  END as status; 
/*
  # Création de la table case_finance_notes pour la gestion des notes financières

  1. Table principale
    - `case_finance_notes` - Notes financières liées aux dossiers
